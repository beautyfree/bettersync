...
export default defineConfig({
  entry: {
    ...
    'adapters/better-sqlite3': 'src/adapters/better-sqlite3.ts',
    'adapters/expo-sqlite': 'src/adapters/expo-sqlite.ts',
    test: 'src/test.ts',
  },
  format: ['esm', 'cjs'],
  dts: true,
  ...
  external: [
    ...
    '@bettersync/pg-adapter',
    '@bettersync/kysely-adapter',
    '@bettersync/prisma-adapter',
    '@bettersync/better-sqlite3-adapter',
    '@bettersync/expo-sqlite-adapter',
